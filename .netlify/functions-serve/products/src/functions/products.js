...
var require_fetch_error = __commonJS({
  "node_modules/node-fetch/lib/fetch-error.js"(exports2, module2) {
...
var require_body = __commonJS({
  "node_modules/node-fetch/lib/body.js"(exports2, module2) {
...
var require_headers = __commonJS({
  "node_modules/node-fetch/lib/headers.js"(exports2, module2) {
...
var require_response = __commonJS({
  "node_modules/node-fetch/lib/response.js"(exports2, module2) {
...
var require_request = __commonJS({
  "node_modules/node-fetch/lib/request.js"(exports2, module2) {
...
var require_node_fetch = __commonJS({
  "node_modules/node-fetch/index.js"(exports2, module2) {
    var parse_url = require("url").parse;
...
var airtable = new Airtable({ apiKey: process.env.VITE_AIRTABLE_API_KEY }).base(process.env.VITE_BASE_ID).table("products");
exports.handler = async (event) => {
  ...
  try {
    ...
    const products = records.map((product) => {
      const { id: id2 } = product;
      const { name, image, price, desc } = product.fields;
      const url = image[0].url;
      return { id: id2, name, url, price, desc };
    });
    return {
